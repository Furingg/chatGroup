package com.furing.chatgroup.result;

import com.fasterxml.jackson.annotation.JsonInclude;
import lombok.Data;
import lombok.experimental.Accessors;

import static com.furing.chatgroup.result.ResultConstant.*;
...
public class CommonResult<T> {
    ...
    private static <P> CommonResult<P> operateFail(P data) {
        return new CommonResult<>(FAIL_CODE, OPERATE_FAIL_MESSAGE, false, data);
    }
    ...
    public static <P> CommonResult<P> operateSuccess(P data) {
        return new CommonResult<P>(SUCCESS_CODE, OPERATE_SUCCESS_MESSAGE, true, data);
    }
